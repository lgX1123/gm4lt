...
class Cifar100(Dataset):
    def __init__(self, imbanlance_rate=0.1, file_path="./data/cifar100/cifar-100-python/", 
                 ...
                 num_cls=100, transform=None, train=True, real_only=False):
        ...
        if train is True:
            if real_only:
                self.data = self.produce_real_train_data(self.imbanlance_rate)
            else:
    ...
    def produce_real_train_data(self, imbanlance_rate):
